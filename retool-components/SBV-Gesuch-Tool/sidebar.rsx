...
>
  <Header>
    <Image
      ...
      margin="0"
      retoolStorageFileId="dea33639-60b8-4e57-81e8-ce17680fb3ee"
  ...
  <Body>
    ...
    >
      <Option
        id="00031"
        icon="bold/interface-content-file-alternate"
        iconPosition="left"
        itemType="page"
        label="Gesuche"
        screenTargetId="Gesuche"
      />
      <Option
        id="00032"
        ...
        itemType="page"
        label="Rapport"
        screenTargetId="Rapport"
      />
      <Option
        id="c78d1"
        disabled={false}
        hidden={false}
        icon="bold/interface-file-sticky-note-add"
        iconPosition="left"
        itemType="page"
        label="Neues Gesuch"
        screenTargetId="neuesgesuch"
      />
      <Event
        event="click"
        method="openPage"
